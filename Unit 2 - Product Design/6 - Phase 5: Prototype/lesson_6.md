...
Watch [Phase 6: Validate.](https://youtu.be/1tXuJDuBhEA)
...
| Term | Definition |
| ---- | ---------- |
| Target User | The user you are designing your product for and the user you expect to use it. |
| NDA | Non-Disclosure Agreement: A confidentiality agreement that prevents someone from disclosing specific information they were given access to, for example an upcoming product roadmap or featureset |
| UX Researcher | Someone who studies the behavior of users |
...
Watch [Planning a User Study.](https://youtu.be/9qRmndcCxVU)
...
<details>
<summary>What are examples of attributes you can consider when selecting your target users to interview?</summary>
...
- Household income
- Gender
- Number of tweets within the last week
- Number of online purchases completed in the last month

All of these are attributes that you can consider when selecting users to interview. Remember, the attributes you use will be highly related to the prototype that you want to test. It’s important to identify attributes that can be used to identify your target user.
</details>

<br>

<details>
<summary>A research plan is helpful because...?</summary>
- Identifies the target user for the interview
- Identifies the key questions that need to be answered
- Lays out an interview script containing the specific questions and order they will be asked in
</details>
...
Write a Research Plan for the Grocery Store Chain App

We need to talk to target users about our product. Let's start writing up a Research Plan to make that happen. In this exercise we'll focus on setting up the study. We'll work on the actual interview questions in the next exercise.

Prepare for your user study by writing up the basic structure in our Research Plan:

- [ ] What do you want to find out?
- [ ] Who are the target users you want to interview?
...
Watch [the solution walkthrough.](https://youtu.be/v45DC1RP6qQ)
...
A lot of work goes into running a user study before the interview even starts! It will be important to correctly identify and invite your target users to participate in the interview. 

At the same time, it’s also important that you identify clear questions that you hope to answer through the study, along with the more specific questions you will ask the user in order to answer the larger overarching question.
